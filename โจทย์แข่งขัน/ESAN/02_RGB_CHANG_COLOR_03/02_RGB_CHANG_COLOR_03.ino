...
void loop() {
  ...
  if (adcMap > 200  and adcMap < 300) {  // 2
    pixels.setPixelColor(0 ,  pixels.Color(R, G, B));     // 0-11,RGB:0-255
    pixels.setPixelColor(1 ,  pixels.Color(R, G, B));     // 0-11,RGB:0-255
  ...
  if (adcMap > 300  and adcMap < 400) {  // 3
    pixels.setPixelColor(0 , pixels.Color(R, G, B));     // 0-11,RGB:0-255
    pixels.setPixelColor(1 , pixels.Color(R, G, B));     // 0-11,RGB:0-255
    pixels.setPixelColor(2 , pixels.Color(R, G, B));     // 0-11,RGB:0-255
  ...
  if (adcMap > 400  and adcMap < 500) {  // 4
    pixels.setPixelColor(0 , pixels.Color(R, G, B));     // 0-11,RGB:0-255
    pixels.setPixelColor(1 , pixels.Color(R, G, B));     // 0-11,RGB:0-255
    pixels.setPixelColor(2 , pixels.Color(R, G, B));     // 0-11,RGB:0-255
    pixels.setPixelColor(3 , pixels.Color(R, G, B));     // 0-11,RGB:0-255
  ...
  if (adcMap > 500  and adcMap < 600) {  // 5
    pixels.setPixelColor(0 ,  pixels.Color(R, G, B));     // 0-11,RGB:0-255
    pixels.setPixelColor(1 ,  pixels.Color(R, G, B));     // 0-11,RGB:0-255
    pixels.setPixelColor(2 ,  pixels.Color(R, G, B));     // 0-11,RGB:0-255
    pixels.setPixelColor(3 ,  pixels.Color(R, G, B));     // 0-11,RGB:0-255
  ...
  if (adcMap > 600  and adcMap < 700) {  // 6
    pixels.setPixelColor(0 ,  pixels.Color(R, G, B));     // 0-11,RGB:0-255
    pixels.setPixelColor(1 ,  pixels.Color(R, G, B));     // 0-11,RGB:0-255
    pixels.setPixelColor(2 ,  pixels.Color(R, G, B));     // 0-11,RGB:0-255
    pixels.setPixelColor(3 ,  pixels.Color(R, G, B));     // 0-11,RGB:0-255
  ...
  if (adcMap > 700  and adcMap < 800) {  // 7
    pixels.setPixelColor(0 ,  pixels.Color(R, G, B));     // 0-11,RGB:0-255
    pixels.setPixelColor(1 ,  pixels.Color(R, G, B));     // 0-11,RGB:0-255
    pixels.setPixelColor(2 ,  pixels.Color(R, G, B));     // 0-11,RGB:0-255
    pixels.setPixelColor(3 ,  pixels.Color(R, G, B));     // 0-11,RGB:0-255
  ...
  if (adcMap > 800  and adcMap < 900) {  // 8
    pixels.setPixelColor(0 ,  pixels.Color(R, G, B));     // 0-11,RGB:0-255
    pixels.setPixelColor(1 ,  pixels.Color(R, G, B));     // 0-11,RGB:0-255
    pixels.setPixelColor(2 ,  pixels.Color(R, G, B));     // 0-11,RGB:0-255
    pixels.setPixelColor(3 ,  pixels.Color(R, G, B));     // 0-11,RGB:0-255
  ...
  if (adcMap > 1100  and adcMap <= 1200) {  // 11
    pixels.setPixelColor(0 ,  pixels.Color(R, G, B));     // 0-11,RGB:0-255
    pixels.setPixelColor(1 ,  pixels.Color(R, G, B));     // 0-11,RGB:0-255
    pixels.setPixelColor(2 ,  pixels.Color(R, G, B));     // 0-11,RGB:0-255
    pixels.setPixelColor(3 ,  pixels.Color(R, G, B));     // 0-11,RGB:0-255
