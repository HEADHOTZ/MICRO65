...
void loop() {
  ...
  tft.setTextSize(2);
  if (state == 0) {
    if (digitalRead(RY1) == 1) tft.drawString("R1 = ON", 130, 60);
    else tft.drawString("R1 = OFF", 130, 60);
    if (digitalRead(RY2) == 1) tft.drawString("R2 = ON", 130, 110);
    else tft.drawString("R2 = OFF", 130, 110);
    if (digitalRead(RY3) == 1) tft.drawString("R3 = ON", 130, 160);
    else tft.drawString("R3 = OFF", 130, 160);
    if (digitalRead(RY4) == 1) tft.drawString("R4 = ON", 130, 210);
    else tft.drawString("R4 = OFF", 130, 210);
  } else tft.drawString("ALL!!", 130, 120);
  if (!digitalRead(SW1)) {
    Timer++;
